...
export const topperInspirations:TopperInspiration[]=[
  ...
  {code:'INSP-TOP-13',slug:'jardim-abelhinhas',title:'Jardim das Abelhinhas',category:'Infantil delicado',levelSlug:'premium',description:'Abelhinhas, flores brancas, folhagens e composição circular delicada em um topo alegre e sofisticado.',image:'https://merlin-topper-assets.floot.app/_cdn/static/89dd0493-a0d6-4389-972e-d03e1702d050-insp-top-13-jardim-abelhinhas.png',palette:['Amarelo mel','Verde sálvia','Branco'],tags:['abelhinhas','jardim','flores']},
  {code:'INSP-TOP-14',slug:'dino-aventura',title:'Dino Aventura',category:'Infantil menino / unissex',levelSlug:'premium',description:'Dinossauros simpáticos, vulcão e folhagens tropicais em uma composição infantil de bastante presença.',image:'https://merlin-topper-assets.floot.app/_cdn/static/8c6f14ff-14ed-4589-bf90-4203f810ac77-insp-top-14-dino-aventura.png',palette:['Verde floresta','Laranja','Azul'],tags:['dinossauro','aventura','infantil']},
  ...
  {code:'INSP-TOP-16',slug:'casamento-floral-dourado',title:'Casamento Floral Dourado',category:'Casamento & bodas',levelSlug:'acetato',description:'Arco dourado, flores brancas, folhagens e monograma em acetato para uma composição elegante e romântica.',image:'https://merlin-topper-assets.floot.app/_cdn/static/c7c39f06-8aa9-4266-8108-1ef2b4da165a-insp-top-16-casamento-floral-dourado.png',palette:['Branco','Verde oliva','Dourado'],tags:['casamento','floral','acetato']},
  {code:'INSP-TOP-17',slug:'bailarina-15-anos',title:'Bailarina 15 Anos',category:'Feminino elegante',levelSlug:'elite-shaker-acetato',description:'Bailarina delicada, laços, flores e composição de alto impacto para uma celebração feminina especial.',image:'https://merlin-topper-assets.floot.app/_cdn/static/491fa7ef-29a8-4527-bdbe-aec9a5b24f27-insp-top-17-bailarina-15-anos.png',palette:['Rosa','Champagne','Dourado'],tags:['bailarina','15 anos','elite']}
];
