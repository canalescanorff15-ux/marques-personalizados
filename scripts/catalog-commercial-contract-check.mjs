...
console.log(`CATALOG_COMMERCIAL_CONTRACT_OK (${catalog.products.length} produtos, ${catalog.categories.length} categorias, todos com preço e imagem; home aponta para catálogo e guia dedicados)`);
