...
export default async function HomePage(){
  ...
  return <main className="premium-site kf-theme home-v672 home-v673 home-v680">
    ...
    <section className="hero premium-hero kf-hero" id="inicio"><div className="container hero-grid"><div className="hero-copy-column" data-reveal>
      ...
      <div className="hero-actions"><Link className="btn btn-primary btn-luxury" href="/catalogo">Ver níveis de topo <Layers3 size={17}/></Link><Link className="btn btn-ghost" href="/monte-seu-topo">Montar meu topo <ArrowUpRight size={16}/></Link><Link className="btn btn-ghost" href="/guia-de-precos">Níveis & preços</Link>{wa&&<a className="home-hero-whatsapp" href={wa} target="_blank" rel="noreferrer"><MessageCircle size={16}/> WhatsApp</a>}</div>
