...
export default async function HomePage(){
  ...
  return <main className="premium-site kf-theme home-v672 home-v673 home-v680 public-v712">
    ...
    <section className="public-home-about" id="sobre"><div className="container public-home-split"><div><div className="eyebrow">Sobre a Merlin</div><h2>Topo personalizado, pensado para o seu bolo.</h2></div><div><p>A Merlin Encantos em Papel é focada em topos de bolo sob encomenda. Cada pedido parte do tema, nome, idade, cores e tamanho do bolo para definir uma composição adequada ao nível de acabamento escolhido.</p><p>As inspirações do site servem como ponto de partida: você pode adaptar cores, elementos e acabamento sem precisar copiar um modelo exatamente.</p></div></div></section>
    ...
    <section className="public-home-contact" id="contato"><div className="container public-home-contact-card"><div><div className="eyebrow">Contato</div><h2>Quer transformar uma ideia em topo?</h2><p>Monte seu briefing pelo site ou fale diretamente pelo WhatsApp. O pedido continua como orçamento, sem checkout automático.</p></div><div className="public-home-contact-actions"><Link className="btn btn-primary btn-luxury" href="/monte-seu-topo">Montar meu topo <ArrowUpRight size={16}/></Link>{wa&&<a className="btn btn-ghost" href={wa} target="_blank" rel="noreferrer"><MessageCircle size={17}/> WhatsApp</a>}{settings.contact_email&&<a className="btn btn-ghost" href={`mailto:${settings.contact_email}`}>{settings.contact_email}</a>}</div></div></section>
