...
export default async function CatalogPage(){
 ...
 return <main className="premium-site kf-theme inspiration-page"><Header settings={settings}/>
  <section className="inspiration-page-hero"><div className="container"><div className="eyebrow"><Layers3 size={14}/> Catálogo de topos</div><h1>Um topo para cada<br/><em>nível de acabamento.</em></h1><p>Não trabalhamos mais com caixas, kits ou lembrancinhas no catálogo público. Nosso foco agora é fazer topos de bolo personalizados com qualidade, do mais simples ao mais elaborado.</p><a className="btn btn-primary btn-luxury" href="#niveis">Comparar níveis <ArrowUpRight size={16}/></a></div></section>
