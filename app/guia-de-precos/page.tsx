...
export default async function PriceGuidePage(){
 ...
 return <main className="premium-site price-guide-page"><Header settings={settings}/>
  <section className="price-guide-hero"><div className="container"><div className="eyebrow">DO SIMPLES AO ELITE</div><h1>Escolha o acabamento.<br/><em>O preço vem do projeto real.</em></h1><p>Cada topo é personalizado. Por isso, o orçamento considera tamanho, tema, quantidade de camadas, shaker, acetato, papéis especiais e prazo antes de definir o valor final.</p><div><Link className="btn btn-primary" href="/monte-seu-topo"><Layers3 size={17}/> Montar meu topo</Link><Link className="btn" href="/catalogo">Comparar níveis</Link></div></div></section>
