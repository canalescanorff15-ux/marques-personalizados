...
export const metadata:Metadata={title:'Inspirações de topos | Merlin Encantos em Papel',description:'Escolha temas e estilos para criar seu topo de bolo personalizado. As antigas inspirações de kits, caixas e cenários foram retiradas do fluxo público.'};

export default async function InspirationsPage(){
 const settings=await getSiteSettings();
 return <main className="premium-site kf-theme inspiration-page"><Header settings={settings}/>
  <section className="inspiration-page-hero"><div className="container"><div className="eyebrow"><Sparkles size={14}/> Inspirações de topos</div><h1>Escolha o tema.<br/><em>Depois escolha o nível.</em></h1><p>A galeria agora é dedicada somente a topos de bolo. As fotos antigas de mesas completas, caixas e lembrancinhas deixam de representar o serviço atual.</p><div className="inspiration-hero-stats"><span><strong>{topperThemes.length}</strong> famílias de tema</span><span><strong>{topperLevels.length}</strong> níveis de acabamento</span><span><strong>1</strong> foco: topos de bolo</span></div></div></section>
